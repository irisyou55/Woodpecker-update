...
public class Comparer
{
    ...
    private static <T> boolean greaterThan(T input1, T input2)
    {
        ...
        {
            result = Integer.valueOf(input1.toString()) > Integer.valueOf(input2.toString()) ? true : false;
        }
        else if (dataType.equals(DataTypeConstant.LONG_FULL))
        {
            result = Long.valueOf(input1.toString()) > Long.valueOf(input2.toString()) ? true : false;
        }
        else if (dataType.equals(DataTypeConstant.FLOAT_FULL))
        {
            result = Float.valueOf(input1.toString()) > Float.valueOf(input2.toString()) ? true : false;
        }
        else if (dataType.equals(DataTypeConstant.DOUBLE_FULL))
        {
            result = Double.valueOf(input1.toString()) > Double.valueOf(input2.toString()) ? true : false;
        }
